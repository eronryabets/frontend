...
import {
    ...
    setSearchTerm,
    setFilters,
    setOrdering // [SORTING] Импортируем наш новый экшен
...
// [SORTING] Опции для селекта сортировки
...
export const WordsList: React.FC = () => {
    ...
    const {
        ...
        search,
        filters,
        ordering // [SORTING] Текущее значение сортировки
    ...
    // ===== useEffect для установки dictionaryId при смене id
    useEffect(() => {
    ...
    // ===== useEffect для установки текущей страницы и поиска из URL
    useEffect(() => {
    ...
    useEffect(() => {
        if (id && dictionaryId) {
            ...
            // [SORTING] Сохраняем сортировку в URL, если нужно
            if (ordering) {
    ...
    // [SORTING] Обработчик смены сортировки
    ...
    return (
        <Box p={3}>
            ...
            {/* --- Блок с кнопками: Добавить слово, Поиск, Фильтр, [SORTING] --- */}
            <Box
                sx={{
                    pl: 2,
                    pb: 2,
            ...
            >
                ...
                {/* [SORTING] Селект для выбора сортировки */}
                ...
                >
                    ...
                    <TextField
                        ...
                        sx={{
                            ...
                            // width: '100%', // Подстраиваемся под ширину родителя
                        }}
